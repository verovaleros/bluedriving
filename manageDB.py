...
#
# TODO
# - The program is not getting all the data for one device correctly. For some reason it return less Locations than there are. I think that when it founds some
